...
export const ARTIST_PROFILE = {
  ...
  bio: `한국 전통 민화와 옛이야기의 따스함, 그리고 특유의 해학적 필치로 사랑받는 그림책 작가 이영경입니다. 
대표작 <아씨방 일곱 동무>, <넉 점 반>, <주먹이>, <봉이 김선달> 등을 통해 대중에게 깊은 여운과 미소를 선사해왔습니다.

'The Color Lab of Young-Kyoung Lee'에서는 단청과 오방색의 오묘한 빛깔, 전통 한지의 기품 있는 질감을 현대적인 감각과 기분 좋은 유머(K-Cuty Folk Art)로 재해석합니다. 그림책 출판부터 전시, IP 라이선싱, 그리고 전통 색채 아트 워크숍을 운영하고 있습니다.`,
  awards: [
    '제39회 백상출판문화상 어린이부문 수상 (<아씨방 일곱 동무>)',
    '어린이도서연구회 추천도서 선정 (<넉 점 반>, <주먹이>)',
    'BIB (브라티슬라바 일러스트레이션 비엔날레) 한국 대표 출품',
    '볼로냐 국제 어린이 도서전 주목받는 한국 작가 선정',
  ],
  stats: {
...
export const IP_CHARACTERS: IPCharacter[] = [
  ...
  },
  {
    id: 'indu-gaksi',
    name: '인두 (인두 각시)',
    englishName: 'Lady Soldering Iron',
    bookTitle: '아씨방 일곱 동무',
  ...
  },
  {
    id: 'baby-nokjeom',
    name: '넉 점 반 아기',
    englishName: 'Little Four-Thirty',
    bookTitle: '넉 점 반',
    personality: '호기심 천국, 천진난만함, 세상 모든 것에 눈길을 빼앗기는 낭만파',
    description: '시계 보라는 심부름을 받고 신나게 나섰다가 길가의 모든 신기한 것들에 매료되는 무해하고 사랑스러운 어린이.',
  ...
  },
  {
    id: 'tiger-minhwa',
    name: 'K-Cuty 까치호랑이',
    englishName: 'Playful Minhwa Tiger',
    bookTitle: '이영경 Folk Art IP',
    personality: '익살스럽고 허당미 가득하며 까치의 지적에 헛웃음 짓는 츤데레',
    description: '액운을 막아주고 복을 가져다주는 해학적인 조선 민화 호랑이의 현대적 재해석.',
